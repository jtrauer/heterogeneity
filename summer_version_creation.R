...
summer_version <- StratifiedModel$new(times, names(initial_values), initial_values, params,
                               ...
                               infectious_compartment="I", initial_conditions_to_total = FALSE, report_progress = FALSE, reporting_sigfigs = 6,
...
summer_version$stratify("infect", seq(0, 2), c("I"),
                        list(epsilon=list("0"=params$prop_I0,
                                          "1"=params$prop_I1,
                                          "2"=params$prop_I2,
                                          "overwrite"=seq(0, 2)),
                             nu=list("0"=params$prop_I0,
                                     "1"=params$prop_I1,
                                     "2"=params$prop_I2,
                                     "overwrite"=seq(0, 2)),
                             gamma=list("0"=params$gamma0,
                                        "1"=params$gamma1,
                                        "2"=params$gamma2,
                                        "overwrite"=seq(0, 2)),
                             mui=list("0"=params$mui0,
                                      "1"=params$mui1,
                                      "2"=params$mui2,
                                      "overwrite"=seq(0, 2))),
